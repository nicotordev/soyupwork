...
export function CoursePreviewBanner({ courseId }: CoursePreviewBannerProps) {
  return (
    <div className="border-b-2 border-amber-500 bg-amber-500/15 px-4 py-3 font-sans">
      <div className="mx-auto flex max-w-6xl flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="space-y-0.5">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-amber-800 dark:text-amber-200 leading-none">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-foreground underline-offset-4 hover:underline shrink-0"
        >
