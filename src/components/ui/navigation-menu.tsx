  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-3 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-xl bg-card text-card-foreground border-2 border-foreground shadow-[4px_4px_0px_0px_var(--foreground)] duration-100 md:w-(--radix-navigation-menu-viewport-width) data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90",
          className
        )}
        {...props}
      />
