    ...
    <DashboardContainer>
      ...
      <div className="mb-5 grid gap-3 sm:grid-cols-3">
        {statsItems.map((stat) => {
          ...
          return (
            <div key={stat.label} className={cn(adminPanelClass, "p-3 bg-card shadow-[4px_4px_0px_0px_var(--foreground)] transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[5px_5px_0px_0px_var(--foreground)]")}>
