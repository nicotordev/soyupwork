...
} from "@/components/dashboard/user-profile-settings-dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <DropdownMenu>
        ...
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <DropdownMenuItem
              className="flex items-center gap-2 p-1.5 font-mono text-[10px] font-bold uppercase text-foreground hover:bg-secondary/15 hover:underline rounded border border-transparent hover:border-foreground/10 transition-colors cursor-pointer focus:bg-secondary/15 focus:text-foreground"
              onSelect={(event) => {
