...
import { ADMIN_WAITLIST_PAGE_SIZE_OPTIONS } from "@/constants/waitlist-admin.constants";
import {
...
import type { AdminWaitlistPagination } from "@/types/admin-waitlist.types";
...
export function WaitlistPagination({ pagination }: WaitlistPaginationProps) {
  ...
  return (
    <footer
      ...
      aria-label="Paginación de lista de espera"
    >
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <Select value={String(pageSize)} onValueChange={updatePageSize}>
            ...
            <SelectContent>
              {ADMIN_WAITLIST_PAGE_SIZE_OPTIONS.map((size) => (
