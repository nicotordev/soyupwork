...
import { ADMIN_USERS_PAGE_SIZE_OPTIONS } from "@/constants/users.constants";
import {
...
import type { AdminUsersPagination } from "@/types/admin-user.types";
...
export function UsersPagination({ pagination }: UsersPaginationProps) {
  ...
  return (
    ...
    >
      <p className="font-mono text-[10px] font-bold uppercase text-muted-foreground">
        Mostrando {rangeStart}–{rangeEnd} de {totalCount} miembros
      </p>
