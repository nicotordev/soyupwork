...
import { ADMIN_RESOURCES_PAGE_SIZE_OPTIONS } from "@/constants/resources-admin.constants";
import {
...
import type { AdminResourcesPagination } from "@/types/resources-admin.types";
...
type ResourcesPaginationBarProps = {
...
export function ResourcesPaginationBar({
  pagination,
}: ResourcesPaginationBarProps) {
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          ...
          <SelectContent>
            {ADMIN_RESOURCES_PAGE_SIZE_OPTIONS.map((size) => (
