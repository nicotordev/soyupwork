...
#     --build-arg NEXT_PUBLIC_AUTH_SIGN_OUT_URL=/ \
...
#     -t soyupwork:latest .
#
# Run (runtime secrets — Postgres, Redis, Stripe, Auth.js, etc.):
#
...
# Explicitly define build args for dockerfile linter compatibility
ARG NEXT_PUBLIC_APP_URL
ARG NEXT_PUBLIC_AUTH_SIGN_OUT_URL
ARG NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY
ARG NEXT_PUBLIC_TURNSTILE_SITE_KEY
ARG NEXT_PUBLIC_LOG_LEVEL
ARG NEXT_PUBLIC_LOG_REMOTE
ARG R2_PUBLIC_URL

ENV NEXT_PUBLIC_APP_URL=${NEXT_PUBLIC_APP_URL} \
    NEXT_PUBLIC_AUTH_SIGN_OUT_URL=${NEXT_PUBLIC_AUTH_SIGN_OUT_URL} \
